...
class Table(Frame):
    def __init__(self, master, columns, column_weights=None, column_minwidths=None, height=500,
                 minwidth=20, minheight=20, padx=5, pady=5, cell_font=('times',15,'bold'), cell_foreground="black",
                 cell_background="white", cell_anchor=W, header_font=('times',15,'bold'), header_background="white",
                 header_foreground="black", header_anchor=CENTER, bordercolor = "black",
                 innerborder=True, outerborder=True, stripped_rows=("white", "white"),
                 on_change_data=None, mousewheel_speed = 2, scroll_horizontally=False,
